#!/usr/bin/env python3
"""
다층 퍼셉트론 은닉층 4개 vs 6개 vs 8개 학습 실행 스크립트

사용법:
1. 동시 학습: python run_training.py
2. 개별 학습: 
   - 은닉층 4개만: python run_training.py --hidden4
   - 은닉층 6개만: python run_training.py --hidden6
...
def main():
    ...
    parser.add_argument('--hidden6', action='store_true', help='은닉층 6개만 학습')
    ...
    if args.hidden4:
        ...
        print("=== 은닉층 6개 다층 퍼셉트론만 학습 시작 ===")
        os.system('python multilayer/main_multilayer.py')
    elif args.hidden8:
        print("=== 은닉층 8개 다층 퍼셉트론만 학습 시작 ===")
        os.system('python multilayer/hidden8/main_hidden8.py')
    else:
        print("=== 은닉층 4개 vs 6개 vs 8개 다층 퍼셉트론 동시 학습 시작 ===")
